...
class TV(models.Model):
    ...
    SNR_Price = models.DecimalField(max_digits=50, decimal_places=3, blank=True)
...
class Cams(models.Model):
    ...
    SNR_SKU = models.CharField(max_length=500, default="")
    SNR_Title = models.CharField(max_length=1000, default=" ", null=True)
    SNR_ModelNo = models.CharField(max_length=500, default=" ", null=True)
    SNR_Brand = models.CharField(max_length=200, default=" ", null=True)
    SNR_UPC = models.CharField(max_length=500, default= " ", null=True)
    SNR_Price = models.DecimalField(max_digits=50, decimal_places=3, blank=True , default=00)
...
class OfficeSupply(models.Model):
    ...
    def __str__(self):
        return self.SNR_SKU if self.SNR_SKU else '' + ' , ' + self.SNR_Title if self.SNR_Title else '' + ' , ' + self.SNR_ModelNo if self.SNR_ModelNo else '' + ' , ' + self.SNR_Brand if self.SNR_Brand else '' + ' , ' + self.SNR_UPC if self.SNR_UPC else '' + ' , ' + str(
            self.SNR_Price) if str(
            self.SNR_Price) else '' + ' , ' + self.SNR_Available if self.SNR_Available else '' + ' , ' + self.SNR_ProductURL if self.SNR_ProductURL else '' + ' , ' + self.SNR_ImageURL if self.SNR_ImageURL else '' + ' , ' + self.SNR_Description if self.SNR_Description else '' + ' , ' + str(
            self.SNR_Date)
